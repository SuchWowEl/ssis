...
# pyside6-rcc new.qrc -o rc_icons.py
...
image = os.path.join(script_dir, 'resources', 'Magnifying-glass.png')
tableStyleSheet = """
            QTableView {
...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(530, 190, 61, 31))
        self.pushButton_3.setStyleSheet("background-color: rgb(171, 12, 71);")
